export default function Register() {
    return (
        <>
            <div style={{
                backgroundImage: "url('https://wallpaper-mania.com/wp-content/uploads/2018/09/High_resolution_wallpaper_background_ID_77701539958.jpg')",
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                      ...
                      Forgot password?
                        ...
                        <p className="mt-10 text-center text-white text-lg">
                            ...
                            <a href="/sign-up" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 text-xl">
                                Sing In
                            </a>
                        </p>
                    </div>
