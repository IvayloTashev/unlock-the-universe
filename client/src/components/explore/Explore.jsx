...
const data = [
    ...
    {title: "Galaxies", image: "/images/galaxies.webp", urlTitle: "glaxies", description: "Galaxies consist of stars, planets, and vast clouds of gas and dust, all bound together by gravity. The largest contain trillions of stars and can be more than a million light-years across. The smallest can contain a few thousand stars and span just a few hundred light-years."},
...
export default function Explore() {
   return (
       ...
       {data.map(x => <ExploreCard key={x.title} title={x.title} image={x.image} urlTitle={x.urlTitle} description={x.description}></ExploreCard>)}
       </div>
   );
}